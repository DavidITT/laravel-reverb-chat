    ...
    <div class="w-full bg-white lg:w-1/2 flex items-center justify-center">
        <div class="max-w-md w-full p-6">
            ...
            <nav class="flex justify-center space-x-4 mb-10">
                <a href="{{route('login')}}"
                   class="text-analogous3 hover:underline hover:text-accent2 text-lg">Login</a>
                <a href="{{route('register')}}" class="text-analogous3 hover:underline hover:text-accent2 text-lg">Register</a>
            </nav>
            <div class="flex-1 flex flex-col justify-center items-center">
                <p class="text-gray-500 text-center">Welcome to our real-time chat application.</p>
                <p class="text-gray-500 text-center">Please login or register to start using the application.</p>
            </div>
        </div>
    </div>
